namespace КурсПроект {
	partial class Forge {
		...
		private void InitializeComponent() {
			...
			priceLabel.Location = new Point(5, 70);
			priceLabel.Name = "priceLabel";
			priceLabel.Size = new Size(239, 16);
			...
			progressBar1.Location = new Point(5, 111);
			progressBar1.Margin = new Padding(3, 2, 3, 2);
			progressBar1.Maximum = 300;
			progressBar1.Name = "progressBar1";
			progressBar1.Size = new Size(238, 10);
			...
			flowLayoutPanel1.Size = new Size(238, 41);
			...
			startForge.Location = new Point(5, 86);
			startForge.Name = "startForge";
			startForge.Size = new Size(238, 25);
